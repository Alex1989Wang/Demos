...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    JWMainTableViewController *mainTableVC = [[JWMainTableViewController alloc] init];
    UINavigationController *naviCon = [[UINavigationController alloc] initWithRootViewController:mainTableVC];
