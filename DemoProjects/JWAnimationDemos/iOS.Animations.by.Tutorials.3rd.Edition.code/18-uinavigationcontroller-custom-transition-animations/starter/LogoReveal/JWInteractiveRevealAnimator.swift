//
//  JWInteractiveRevealAnimator.swift
//  LogoReveal
//
...
class JWInteractiveRevealAnimator: UIPercentDrivenInteractiveTransition,
...
CAAnimationDelegate {
    ...
    func handlePanGesture(panGesture: UIPanGestureRecognizer) {
        let transition = panGesture.translation(in:
            panGesture.view!.superview!)
        var progress: CGFloat = abs(transition.x/(200.0))
        progress = min(0.99, max(progress, 0.01))
