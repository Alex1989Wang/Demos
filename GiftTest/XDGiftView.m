...
@interface XDGiftView ()<UICollectionViewDataSource, UICollectionViewDelegate, XDContinuousSendViewDelegate>
// 顶部
...
@property (nonatomic, weak) XDAniGiftBanner *aniGiftView; // 送出的礼物视图
@property (nonatomic, weak) XDContinuousSendView *lianSongView; // 送出的礼物视图
// 上次点击时间
...
- (XDContinuousSendView *)lianSongView
{
    if (_lianSongView == nil) {
        
        XDContinuousSendView *lianSong = [[XDContinuousSendView alloc] init];
